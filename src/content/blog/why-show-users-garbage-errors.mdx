...
<figure>
  <img src="/images/posts/why-show-users-garbage-errors/trainline.jpg" alt="Error box on the trainline iOS app showing Oops, and an unintelligable error we'll walk through now." />
...
<figure>
  <img src="/images/posts/why-show-users-garbage-errors/bunq.jpg" alt="Bunq iOS app showing error message: Invalid status ACCEPTED_PENDING_RESPONSE for SecureCode with status ACCEPTED." />
...
<figure>
  <img src="/images/posts/why-show-users-garbage-errors/twitter.jpg" alt="Error message on twitter iOS app: The operation couldn't be completed. (com.twitter.TFSTwitterAPIError error 120.)" />
