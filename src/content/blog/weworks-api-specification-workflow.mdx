...
![Pie chart showing only 12% of customers had a client library for any given API or service in their language (and we were all using ruby)](../../images/wework-workflow/sdk.png)
...
Over time we can programatically add other things like [HTTP
...
you, so don't waste your time duct-taping all this crap together.
