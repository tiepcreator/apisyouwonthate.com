...
_Every API is following some sort of paradigm, whether it knows it or not. Learn the differences, for when you talk to…_blog.apisyouwonthate.com](https://blog.apisyouwonthate.com/understanding-rpc-rest-and-graphql-2f959aadebe7 "https://blog.apisyouwonthate.com/understanding-rpc-rest-and-graphql-2f959aadebe7")[](https://blog.apisyouwonthate.com/understanding-rpc-rest-and-graphql-2f959aadebe7)
...
![A quick guide to picking an approach for your next API, in the form of a decision flow diagram.](https://cdn-images-1.medium.com/max/2560/0*JlrqgaKLKu3atK71.png)
