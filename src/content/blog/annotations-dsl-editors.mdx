...
Designing an API with 100 endpoints like that will get you two at least one keyboard (maybe two if it's a Macbook). Designing a few APIs could drive you bonkers. 
