...
coverImage: overloaded-bike.jpeg
date: 2019-04-04
type: blog
author: Phil Sturgeon
subtitle: Specifications, Descriptions, Definitions, Spec Files, Contracts, ugh… they’re the same thing!
---
...
Every utility on [OpenAPI.Tools](https://openapi.tools/) uses them slightly
differently. [Speccy](https://github.com/wework/speccy) uses definition B for its optional (-r)
