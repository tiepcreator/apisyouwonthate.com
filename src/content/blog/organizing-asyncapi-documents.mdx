...
_Written by_ [_Fran Méndez_](https://medium.com/@fmvilas) _and re-posted here with permission._
...
![One publisher and one subscriber, both sharing the UserSignUp message.](https://cdn-images-1.medium.com/max/800/1*DxwJA1tNl2-WHeVhOQNg4A.png)
...
![One publisher and various subscribers. All of them sharing the UserSignUp message.](https://cdn-images-1.medium.com/max/800/1*b2VLCswy1jx2OX2PvUBDGA.png)
...
![The value of $ref should be “common/messages.json#UserSignedUp”.](https://cdn-images-1.medium.com/max/800/1*S3ztpzerE3X2T8k8tuqYOw.png)
...
_AsyncAPI is an open source project running on donations so_ **please,** [**consider donating**](https://opencollective.com/asyncapi)**.** 🙌

_Originally published at_ [_medium.com_](https://medium.com/asyncapi/organizing-your-asyncapi-documents-12bccecd9ced) _by_ [_Fran Méndez_](https://medium.com/@fmvilas) _on March 1, 2019._