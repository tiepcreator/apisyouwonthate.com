...
The work for JSON Schema alignment is pretty much done, but there are [a few licks of paint](https://github.com/OAI/OpenAPI-Specification/issues/2099) until its completely sorted. These tweaks might come in over the course of the release condidate process, the first of which is supposedly going to be the end of February (this month?! 🤯)
