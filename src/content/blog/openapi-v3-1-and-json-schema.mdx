...
- [Webhooks](https://apisyouwonthate.com/blog/openapi-callbacks-and-webhooks/) which do not have to be documented as callbacks underneath a specific operation
