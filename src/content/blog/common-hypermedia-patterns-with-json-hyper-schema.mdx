...
Here, our next Link Description Object (or LDO, as described in a [previous article](https://blog.apisyouwonthate.com/getting-started-with-json-hyper-schema-184775b91f)) has an optional query parameter called cursor (as defined in the URI template href). The templatePointers object states that the cursor parameter should come from the next_page_cursor value in your JSON instance. This gives your client all the necessary to automate constructing the “next page” url.
...
[here](http://json-schema.org/implementations.html#hyper-schema).

If you’d like to learn more about the concept of hypermedia, check out this
article on [representing
state](https://blog.apisyouwonthate.com/representing-state-in-rest-and-graphql-9194b291d127).
