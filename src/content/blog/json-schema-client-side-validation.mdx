...
testing](https://apisyouwonthate.com/blog/keeping-documentation-honest),
...
APIs](https://apisyouwonthate.com/blog/api-versioning-has-no-right-way)
...
how names
work](https://www.kalzumeus.com/2010/06/17/falsehoods-programmers-believe-about-names/),
...
[jsonschemavalidator.net](https://www.jsonschemavalidator.net/) and paste those in.
Removing the name field triggers an error as we have `"required": ["name"]` in
there.

![screenshot showing object:name is missing](https://cdn-images-1.medium.com/max/800/1*JpoArUNNqO9Fy-CtNXaaXg.png)

Another validation rule could be triggered if you enter date of birth in an
incorrect format.

![screenshot showing '2007-01' does not valiate against format 'date'](https://cdn-images-1.medium.com/max/800/1*kFVCBlBeVUAoA_OYMrspQw.png)
...
_Learn about [HTTP caching for clients](https://apisyouwonthate.com/blog/http-client-response-caching)._
...
Repo](https://github.com/apisyouwonthate/surviving-other-peoples-apis-code).
