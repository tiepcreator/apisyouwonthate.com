...
![screenshot showing object:name is missing](/images/posts/json-schema-client-side-validation/missing-name.png)

Another validation rule could be triggered if you enter date of birth in an
incorrect format.

![screenshot showing '2007-01' does not valiate against format 'date'](/images/posts/json-schema-client-side-validation/missing-date.png)
