...
OpenAPI](https://github.com/OAI/OpenAPI-Specification/blob/master/versions/3.0.1.md#schema-object)
- it can be used to [generate meaningful and beautiful human-readable
...
“downloaded” from
[http://example.com/schemas/user.json](http://example.com/schemas/user.json) and
