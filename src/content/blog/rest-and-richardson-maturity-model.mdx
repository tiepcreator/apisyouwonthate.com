...
and pending doesnt mean you can pay it anymore... Client applications break, or need to be versioned, both
...
application knows when to pay, and so long as a good hypermedia format os is
