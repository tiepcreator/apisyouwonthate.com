...
If you are already doing validation in the controller then this will be a lot
nicer, and if you are doing validation in your model you can delete a whole
bunch of noise. If you did not have validation before, then using this approach
...
swaggerValidator.init('./openapi.yaml').then(function () {
  const app = express();
  app.use(express.json());
...
- **Node.js:** [express-swagger-ajv-validator](https://github.com/Zooz/express-ajv-swagger-validation) / [express-openapi-validate](https://github.com/Hilzu/express-openapi-validate)
