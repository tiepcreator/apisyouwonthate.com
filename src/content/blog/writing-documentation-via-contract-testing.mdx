...
_You’ll need to watch out for the [divergence
issue](https://blog.apisyouwonthate.com/openapi-and-json-schema-divergence-part-1-1daf6678d86e)_,
...
- Node/Jest: [jest-json-schema](https://github.com/americanexpress/jest-json-schema) (by American Express 😲)
