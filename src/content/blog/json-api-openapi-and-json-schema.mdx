...
[JSON API](http://jsonapi.org/) is a specification written by a group of folks,
with the goal of being an anti-[bikeshedding](http://bikeshed.org) tool for
...
HTTP_](https://blog.apisyouwonthate.com/representing-state-in-rest-and-graphql-9194b291d127)_,
...
Fieldsets](http://jsonapi.org/format/#fetching-sparse-fieldsets). You can let
...
documents](http://jsonapi.org/format/#document-compound-documents), it takes a
stab at [pagination](http://jsonapi.org/format/#fetching-pagination), makes [a
vague hand-wave at filtering](http://jsonapi.org/format/#fetching-filtering),
and covers things like [error
objects](http://jsonapi.org/examples/#error-objects-basics) for those not using
...
[OpenAPI](http://openapis.org/) and [JSON Schema](http://json-schema.org/) are
...
time](https://blog.apisyouwonthate.com/openapi-and-json-schema-divergence-part-1-1daf6678d86e).
...
[tooling](http://openapi.tools/), so it’s popularly used for mocking services
...
JSON API
payloads](https://blog.apisyouwonthate.com/common-hypermedia-patterns-with-json-hyper-schema-17c78cf884ff),
...
on_](https://blog.apisyouwonthate.com/lets-stop-building-apis-around-a-network-hack-9a68f7e83dd2)_.
...
API_](https://blog.apisyouwonthate.com/making-the-most-of-json-api-7fb51f4407aa)
