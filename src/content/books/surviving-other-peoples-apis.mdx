...
thumbnail: surviving-other-peoples-apis-thumb.jpg
author: Philip Sturgeon
subtitle: Designing the world's most beautiful API is only half the story, somebody needs to interact with it!
...
leanpubLinks: [{
  label: 'Preorder on Leanpub',
  url: 'https://leanpub.com/surviving-other-peoples-web-apis',
}]
type: book
---
