module.exports = {
  async redirects() {
    return [
      ...
      {
        source:
          '/a-happy-compromise-between-customization-and-cacheability-:id',
        destination:
      ...
      },
      {
        ...
        destination:
          '/blog/health-checks-for-rest-grpc-apis-kubernetes-and-beyond',
        permanent: true,
      },
      {
        source: '/json-api-openapi-and-json-schema-working-in-harmony-:id',
        destination:
          '/blog/json-api-openapi-and-json-schema-working-in-harmony',
        permanent: true,
      },
      {
      ...
      {
        source:
          '/the-many-amazing-uses-of-json-schema-client-side-validation-:id',
        destination:
